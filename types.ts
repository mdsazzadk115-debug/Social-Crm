...
export interface ClientInteraction {
    id: string;
    date: string;
    type: 'CALL' | 'MEETING' | 'EMAIL' | 'WHATSAPP' | 'OTHER' | 'INVOICE' | 'TASK' | 'SALE' | 'BALANCE' | 'SMS';
    notes: string;
...
export interface CampaignRecord {
    ...
    product_cost?: number;
    created_at: string;
    // Fix: Added missing properties for BigFish.tsx
    impressions?: number;
    reach?: number;
    clicks?: number;
}
...
export interface BigFish {
    ...
    start_date: string;
    end_date?: string;
    // Fix: Added missing properties for BigFish.tsx and constants.ts
    package_name?: string;
    is_retainer?: boolean;
...
// Fix: Added missing interfaces for Dashboard, Messaging, OnlineCustomers, SalesGoals, AdSwipeFile, MessageBaba pages
